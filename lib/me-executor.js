...
var rebuildParameters = function (deviceInfo, parameters) {
        ...
        if (error) {
            ...
            async.waterfall([
                ...
                function (deviceInfo, innerCallback) {
                    ...
                    if (-1 !== found && "0001" === message.cmd.cmdCode) {
                        //补全接收器命令码
                    ...
                    if ("050608070001" === deviceType
                        ...
                        message.cmd.parameters = rebuildParameters(deviceInfo, message.cmd.parameters);
                    }
